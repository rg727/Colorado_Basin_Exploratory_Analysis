...
MonthlyQ_all = readFiles('ym2015x.xbm', 16, 94)
...
for i in range(start, stop):
    for realization in range(10):
       # create matrices to store nYears of synthetic (_s), real-space (AnnualQ_s), 
        ...
        writeNewFiles('ym2015x.xbm', 16, i, realization+1, MonthlyQ_s, '')
        
        # write new irrigation demands to file for LHsample i
        writeNewFiles('D:/Documents/ym2015_StateMod_modified/ym2015_StateMod_modified/StateMod/ym2015B.iwr', 370, i, realization+1, MonthlyIWR_s, 'a') # a for all uncertainties
        
        # write new irrigation demands to file for LHsample i
        writeNewFiles('D:/Documents/ym2015_StateMod_modified/ym2015_StateMod_modified/StateMod/ym2015B.iwr', 370, i, realization+1, MonthlyIWR_s_flowOnly, 'f') # f for flow uncertainties only
